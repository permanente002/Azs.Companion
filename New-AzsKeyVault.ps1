...
Provide an AAD group 'Display Name' that will be granted the following access to the Key Vault
    SECRETS | GET, LIST, SET
    CERTIFICATES | GET, LIST, CREATE, UPDATE, GETISSUERS, SETISSUERS, LISTISSUERS

.Parameter UserAccessPolicy
Provide an AAD individual account UPN (e.g. alias@domain.com) that will be granted the following access to the Key Vault.
    SECRETS | GET, LIST, SET
    CERTIFICATES | GET, LIST, CREATE, UPDATE, GETISSUERS, SETISSUERS, LISTISSUERS
...
param (
    ...
    [parameter(Mandatory = $false)] [array]$AccessPolicy,
    [parameter(Mandatory = $false)] [array]$UserAccessPolicy
